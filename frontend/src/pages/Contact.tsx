          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">cuonghungnguyentop@gmail.com</p>
                    <p className="text-muted-foreground">smartrecruit@support.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+84 987547235</p>
                    <p className="text-muted-foreground">Mon-Fri 9am-6pm (GMT+7)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Smart Recruit Avenue</p>
                    <p className="text-muted-foreground">123 Smart Recruit Street, Ho Chi Minh City, Vietnam</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  {(["linkedin", "github", "facebook"] as const).map((social) => (
                    <SocialMediaIcon key={social} platform={social} />
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="bg-card border border-border rounded-3xl p-8 lg:p-10 shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-4 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-lg transition-all shadow-lg hover:shadow-xl hover:scale-[1.02]"
                >
                  Send Message
                </button>
